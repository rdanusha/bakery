	...
	public static function orddd_sync_calendar_instructions_callback() {
		...
		<div class="description orddd-info_target api-instructions" style="display: none;">
			<ul style="list-style-type:decimal;">
				...
				<li><?php esc_html_e( "Go to 'Credentials' menu in the left side pane and click on 'New Credentials' dropdown.", 'order-delivery-date' ); ?></li>
				<li><?php esc_html_e( "Click on New Credentials dropdown and select 'Service account key'.", 'order-delivery-date' ); ?></li>
				<li><?php esc_html_e( "Click 'Service account' and select 'New service account' and enter the name.", 'order-delivery-date' ); ?></li>
				<li><?php esc_html_e( "Now select key type as 'P12' and create the service account. Choose the desired service role from the popup and click on create. A file with extension .p12 will be downloaded.", 'order-delivery-date' ); ?></li>
				<li>
				<?php
				...
				<li><?php esc_html_e( "Create a new Calendar by clicking on '+' sign next to 'Add a friends calendar' text box on left side pane. <b>Try NOT to use your primary calendar.</b>", 'order-delivery-date' ); ?></li>
				<li><?php esc_html_e( 'Give a name to the new calendar, e.g. Order Delivery Date calendar. <b>Check that Calendar Time Zone setting matches with time zone setting of your WordPress website.</b> Otherwise there will be a time shift.', 'order-delivery-date' ); ?></li>		
				<li><?php esc_html_e( "Paste already copied 'Service Account ID' from Manage service account of Google APIs console to 'Add People' field under 'Share with specific people'.", 'order-delivery-date' ); ?></li>
				<li><?php esc_html_e( "Set 'Permission Settings' of this person as 'Make changes to events' and add the person. Now create the calendar.", 'order-delivery-date' ); ?></li>
				<li><?php esc_html_e( "Select the created calendar and click 'Calendar settings'. Now copy 'Calendar ID' value on Calendar Address row and paste the value to 'Calendar to be used' field of Order Delivery Date settings.", 'order-delivery-date' ); ?></li>
