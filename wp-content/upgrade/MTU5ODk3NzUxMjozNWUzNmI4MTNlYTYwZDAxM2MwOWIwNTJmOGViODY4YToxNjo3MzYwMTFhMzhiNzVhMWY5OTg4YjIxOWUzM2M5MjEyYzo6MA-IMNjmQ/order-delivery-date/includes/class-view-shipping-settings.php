...
class ORDDD_View_Shipping_Settings_Table extends WP_List_Table {
	...
	public function get_columns() {
		$columns = array(
				...
				'actions'  		     => __( 'Edit Setting', 'order-delivery-date' )
		);
	...
	public function column_default( $shipping_settings, $column_name ) {
		switch ( $column_name ) {
		    case 'status' :
		        ...
		        break;
			case 'actions' :
	 			$value = '<a href=\'admin.php?page=order_delivery_date&action=shipping_based&mode=edit&row_id=' . $shipping_settings->row_id . '\' class=\'edit_shipping_setting\'><img src="' . plugins_url() . '/order-delivery-date/images/edit.png" alt="Edit" title="Edit"></a>';
				break;
			default:
